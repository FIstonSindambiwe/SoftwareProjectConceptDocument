// src/pages/dashboard/programs/EditProgramPage.jsx
...
const EditProgramPage = () => {
  ...
  const loadData = async () => {
    try {
      const [programData, locationsData] = await Promise.all([
        programService.getProgram(id),
        programService.getActiveLocations()
      ]);
      ...
      setFormData({
        ...
        focus_areas: programData.focus_areas || [],
        age_range_min: programData.age_range_min || 10,
        age_range_max: programData.age_range_max || 18,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await programService.updateProgram(id, cleanedData);
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-500">Update program information</p>
          </div>
        </div>
