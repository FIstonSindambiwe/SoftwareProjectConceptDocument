...
const ProfilePage = () => {
  ...
  const { updateProfile, isLoading } = useUsers(); // CORRECTED: using updateProfile instead of updateCurrentProfile
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // CORRECTED: using updateProfile instead of updateCurrentProfile
