// src/components/milestones/MilestoneFilters.jsx
...
const MilestoneFilters = ({ 
  ...
  const loadPrograms = async () => {
    try {
      ...
      const programsList = data.results || data || [];
  ...
  const hasActiveFilters = searchTerm || programFilter || completionFilter || overdueFilter;
        ...
        <div className="bg-blue-50 px-6 py-3 border-t border-blue-100">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {programFilter && (
                <span className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-blue-200 text-blue-800">
                  Program: {programs.find(p => p.id === parseInt(programFilter))?.name}
                  <button
              ...
              {completionFilter && (
                <span className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-blue-200 text-blue-800">
                  {completionFilter === 'true' ? 'Completed' : 'Pending'}
                  <button
              ...
              {overdueFilter && (
                <span className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-blue-200 text-blue-800">
                  {overdueFilter === 'true' ? 'Overdue' : 'Not Overdue'}
                  <button
